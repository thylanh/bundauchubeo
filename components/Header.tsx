    ...
    <header className="w-full flex flex-col md:flex-row justify-between items-center md:items-start pt-6 pb-4 border-b-2 border-dashed border-vintage-brown gap-6 md:gap-0">
      ...
      <div className="flex flex-col items-center gap-2">
        <div className="w-24 h-24 md:w-32 md:h-32 bg-vintage-yellow flex items-center justify-center border-4 border-vintage-brown shadow-md transform -rotate-4 rounded-3xl">
          <div className="text-center font-bold text-vintage-brown flex flex-col items-center">
            <span className="text-3xl md:text-4xl tracking-tighter leading-none" style={{ fontFamily: 'var(--font-heading)' }}>Nhà Shen</span>
      ...
      <div className="flex-1 flex flex-col items-center w-full">
        <div className="flex gap-2 md:gap-4 items-center mb-1 w-full max-w-lg justify-center">
           ...
           <span className="text-xs md:text-sm font-bold text-vintage-brown uppercase tracking-widest text-center font-sans">bún đậu nhà shen ăn là phải khen</span>
           <div className="h-0.5 bg-vintage-brown flex-1 rounded-full"></div>
        </div>
        ...
        <h2 className="text-center md:text-left text-5xl sm:text-7xl md:text-9xl font-extrabold text-vintage-brown tracking-widest stylized-outline uppercase" style={{ fontFamily: 'var(--font-heading)', textShadow: '2px 2px 0px #fbc02d, -1px -1px 0px #fff' }}>BÚN NHÀ SHEN</h2>
        ...
        <div className="hidden md:flex gap-2 md:gap-4 items-center mt-3 w-full max-w-lg justify-center">
           ...
           <span className="text-sm md:text-base font-bold text-vintage-brown uppercase tracking-wider text-center font-sans">Du lịch Một Vòng Cùng Bún Đậu Nhà Shen</span>
           <div className="h-px bg-vintage-brown flex-1"></div>
        </div>
      </div>
