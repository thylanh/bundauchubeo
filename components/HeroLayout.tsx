  ...
  return (
    <section className="w-full flex flex-col md:flex-row gap-8 mb-12">
      ...
      <div className="w-full md:w-1/4 flex flex-col items-center">
        <h2 className="text-xl font-bold text-accent-red uppercase tracking-widest border-y-2 border-vintage-brown py-1 mb-4 flex items-center justify-center w-full" style={{ fontFamily: 'var(--font-heading)' }}>
          BAN ĐỌC CHÚ Ý
        </h2>
        <div className="w-full aspect-square bg-vintage-brown flex flex-col items-center justify-center text-[#fbc02d] relative clip-triangle-bottom border-[6px] border-[#fbc02d]">
          <h3 className="text-4xl px-2 font-bold mb-14 text-center leading-tight uppercase" style={{ fontFamily: 'var(--font-heading)' }}>
            BÚN<br/>NHÀ<br/>SHEN
          </h3>
          <div className="absolute bottom-0 w-0 h-0 border-l-[100px] border-l-transparent border-t-[80px] border-t-vintage-brown border-r-[100px] border-r-transparent transform translate-y-[80px]"></div>
        </div>
      </div>
      ...
      <div className="w-full md:w-1/2 flex flex-col border-x-2 border-dashed border-vintage-brown px-4">
        ...
        <div className="mt-8 pt-4 border-t-2 border-dashed border-vintage-brown">
          <h2 className="text-3xl font-extrabold text-vintage-brown uppercase tracking-widest text-center mb-6" style={{ fontFamily: 'var(--font-heading)' }}>
            Món Ngon Hà Thành
          </h2>
          <p className="font-serif text-lg leading-relaxed first-letter:text-6xl first-letter:font-bold first-letter:float-left first-letter:mr-3 first-letter:mt-1 first-letter:text-accent-red" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <div className="w-full md:w-1/4 flex flex-col">
        <h2 className="text-4xl font-bold text-accent-red uppercase tracking-widest mb-4 leading-tight border-b-2 border-vintage-brown pb-4" style={{ fontFamily: 'var(--font-heading)' }}>
        ...
        <div className="font-serif text-base leading-relaxed text-justify relative before:content-[''] before:w-8 before:h-0.5 before:bg-vintage-brown before:absolute before:-top-2 before:left-1/2 before:-translate-x-1/2" style={{ fontFamily: 'var(--font-sans)' }}>
          <p className="mb-4">
            Ngày xưa, ở một con hẻm nhỏ có một quán bún đậu mắm tôm nhỏ xíu. Quán chỉ có vài chiếc bàn gỗ thấp, mấy cái ghế nhựa cũ và một chiếc quạt quay kẽo kẹt cả ngày. Nhưng lúc nào quán cũng đông khách.
Chủ quán là một bà cụ đã ngoài bảy mươi tuổi. Ai cũng gọi bà là bà Năm. Mỗi sáng sớm, bà dậy từ lúc trời còn chưa sáng để chuẩn bị bún, rán đậu, luộc thịt và pha mắm tôm.
          </p>
